...
export default {
  ...
  data() {
    return {
      defaultAvatar: '/images/default-pharmacy.png',
  ...
  computed: {
    ...
    processedDocuments() {
      if (!this.pharmacy.documents || !this.pharmacy.documents.length) return [];
      
      // Handle different document structures
      return this.pharmacy.documents.map(doc => {
