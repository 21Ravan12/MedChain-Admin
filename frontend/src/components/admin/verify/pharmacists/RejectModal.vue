<template>
    <div class="reject-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3>Reject Pharmacist Verification</h3>
        ...
        <div class="modal-body">
          <div class="pharmacist-preview" v-if="pharmacist">
            <div class="avatar">
              <img :src="pharmacist.avatar || defaultAvatar" alt="Pharmacist Photo">
            </div>
            <div class="details">
              <h4>{{ pharmacist.fullName }}</h4>
              <p class="credentials">{{ pharmacist.qualification }}</p>
            </div>
          </div>
          ...
          <div class="reject-form">
            ...
            <textarea
              ...
              placeholder="Please specify the reason for rejecting this pharmacist's verification..."
              rows="5"
              maxlength="500"
            ></textarea>
  ...
  export default {
    ...
    .pharmacist-preview .avatar img {
      width: 100%;
      height: 100%;
      object-fit: cover;
    }
    
    .pharmacist-preview h4 {
      margin: 0 0 5px 0;
      font-size: 16px;
      color: #2c3e50;
    }
    
    .pharmacist-preview .specialty {
      margin: 0;
      font-size: 14px;
      color: #7f8c8d;
      font-style: italic;
