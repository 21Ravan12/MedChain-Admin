        ...
        <div class="header-info">
          ...
          <div class="position">
            ...
            <span class="hospital-badge">
              <i class="fas fa-hospital"></i> {{ admin.hospitalName }}
            </span>
          </div>
          ...
          <div class="contact-info">
            ...
            <div class="contact-item">
              ...
              <span>Registered: {{ formatDate(admin.registrationDate) }}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="detail-section">
          ...
          <div class="detail-grid">
            <div class="detail-item">
              ...
              <p>{{ admin.qualifications || 'Not specified' }}</p>
            </div>
            <div class="detail-item">
              <label><i class="fas fa-briefcase"></i> Department</label>
              <p>{{ admin.department || 'Not specified' }}</p>
            </div>
            <div class="detail-item">
        ...
        <div class="rejection-section" v-if="admin.rejectionReason">
          ...
          <div class="rejection-content">
            <div class="rejection-meta">
              ...
              <span class="rejected-by">By: {{ admin.rejectedBy || 'Administrator' }}</span>
            </div>
...
export default {
  ...
  methods: {
    getDocumentName(doc) {
      return typeof doc === 'string' ? doc : doc.filename || doc.name || 'Document';
    },
    getDocumentIcon(doc) {
    ...
    viewDocument(document) {
      const url = typeof document === 'object' ? document.url : document;
    ...
    downloadProfile() {
      console.log('Downloading admin profile');
    }
  }
}
</script>
