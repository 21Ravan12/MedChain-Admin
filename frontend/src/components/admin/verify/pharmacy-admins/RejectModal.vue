    ...
    <div class="reject-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3>Reject Pharmacy Admin Verification</h3>
        ...
        <div class="modal-body">
          <div class="admin-preview" v-if="admin">
            <div class="avatar">
              <img :src="admin.avatar || defaultAdmin" alt="Pharmacy Admin Photo">
            </div>
            <div class="details">
              <h4>{{ admin.name }}</h4>
          ...
          <div class="reject-form">
            ...
            <textarea
              ...
              placeholder="Please specify the reason for rejecting this pharmacy admin's verification..."
              rows="5"
              maxlength="500"
            ></textarea>
