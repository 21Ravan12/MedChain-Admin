    ...
    <div class="reject-modal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="hospital-preview" v-if="hospital">
            <div class="avatar">
              <img :src="hospital.avatar || defaultHospital" alt="Hospital Logo">
            </div>
            <div class="details">
              <h4>{{ hospital.name }}</h4>
              <p class="type">{{ hospital.type }}</p>
            </div>
          </div>
          ...
          <div class="reject-form">
            ...
            <textarea
              ...
              placeholder="Please specify the reason for rejecting this hospital's verification..."
              rows="5"
            ></textarea>
