    ...
    <div class="modal-content">
      ...
      <div class="hospital-header">
        <div class="avatar-container">
          <div class="avatar">
            <img :src="hospital.avatar || defaultAvatar" :alt="hospital.name + ' Logo'">
...
export default {
  ...
  data() {
    return {
      defaultAvatar: '/images/default-hospital.png',
  ...
  computed: {
    ...
    processedDocuments() {
      if (!this.hospital.documents || !this.hospital.documents.length) return [];
      
      // Handle different document structures
      return this.hospital.documents.map(doc => {
