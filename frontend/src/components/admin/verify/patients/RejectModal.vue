    ...
    <div class="reject-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3>Reject Patient Verification</h3>
        ...
        <div class="modal-body">
          <div class="patient-preview" v-if="patient">
            <div class="avatar">
              <img :src="patient.avatar || defaultAvatar" alt="Patient Photo">
            </div>
            <div class="details">
              <h4>{{ patient.fullName }}</h4>
              <p class="demographics">{{ patient.age }} years • {{ patient.gender }}</p>
            </div>
          </div>
          ...
          <div class="reject-form">
            ...
            <textarea
              ...
              placeholder="Please specify the reason for rejecting this patient's verification..."
              rows="5"
              maxlength="500"
            ></textarea>
